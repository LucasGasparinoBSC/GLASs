...
elseif(CMAKE_C_COMPILER_ID STREQUAL "NVHPC" OR CMAKE_C_COMPILER_ID STREQUAL "PGI")
	...
	if(USE_GPU)
		...
		set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "-acc -cuda -gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo -Minfo=all")
		set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "-acc -cuda -gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo -Minfo=all")
		set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "-acc -cuda -gpu=cc${GPU_CC},cuda${GPU_CUDA},lineinfo -Minfo=all")
	endif()
else()
